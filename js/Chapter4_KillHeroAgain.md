...
每个勇者都渴望着一次冒险，让我们这次假设勇者终于可以很风光地来到一个关卡面前，每次闯关完成，就可以进入到下一个关卡，比如闯过第一关，然后是第二关、第三关……

——当然，如果你不喜欢这么样的描述，我们可以简简单单地描述为：让程序从1输出到100。怎么做？你已经知道了如何传递参数、如何调用函数，接下来，就是放空自己，想想怎么设计一个函数，执行输出1~100了。
...
**如果你似乎有点不理解递归过程，我们先来做一件事：让递归的过程变慢一点。**
