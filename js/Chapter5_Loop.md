...
答案是：分别弹出“初始条件”、“判断是否进入循环”、“啦啦啦，进入到循环了~~~”，没了。看出来了吧，这就是break的厉害之处。好了，让我们来试试如何修改之前的代码，具有“判断勇者死活，如果勇者死了，就跳出循环”的功能。
...
>
<img src = "srcImg/shockCat.jpg"  width="80px" />
Q：那，那逗号有什么其他作用吗？

>
<img src = "srcImg/coldFace.jpg"  width="80px" />
A：当然有了，分隔不同的语句呗。而且，请记住，最后面的那句话会返回对应的结果，也就是说，整句话以最后那句为准——这就叫逗号表达式。
